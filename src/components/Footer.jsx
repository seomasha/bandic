...
export default function Footer() {
  ...
  return (
    <footer className="bg-ink-950 text-white/80 noise-overlay">
      <div className="mx-auto max-w-7xl px-5 lg:px-8 py-20 flex flex-col gap-12 md:flex-row md:justify-between md:gap-8">
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-5 lg:px-8 py-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
